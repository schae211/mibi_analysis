...
Do the analysis again, but stratify by certain features.

a) Whether the tumors are compartimentalized or not (see mixing score)

b) Patient information (e.g. grade of the tumor)

c) Composition of the tissue (e.g. what kind of immune cells are present?)
