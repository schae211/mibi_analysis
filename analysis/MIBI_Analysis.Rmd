...
center of mass function in scipy (python).
...
# I guess these were not real cells, so I can ignore them?
```
...
median ± 1.5 * IQR (interquantile range), we can again the broad variablity.
